        ...
        <div className="">
          ...
          <div className="flex items-center -mx-4 overflow-x-auto overflow-y-hidden sm:justify-start flex-nowrap ">
            ...
            <div
              ...
              className="bg-primary p-2 ml-5 rounded-full hover:bg-secondary hover:text-primary text-secondary text-2xl cursor-pointer hover:scale-105">
              <MdBookmarkAdd />
            </div>
          </div>
          <Outlet />
        ...
        <div className="flex flex-wrap py-6 gap-2 border-t border-dashed border-gray-400">
          {tags.map((tag, index) => (
            <a
              ...
              href="#"
              key={index}
              className="px-3 py-1 hover:underline bg-secondary text-gray-900 rounded-md">
              #{tag}
            </a>
          ))}
        </div>
